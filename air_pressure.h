...
private:
  ...
  static const int MIDI_EXP_ITP_STEP = 16;
  static const int STABLE_COUNT = 300;          // *10msec = 3sec
  static const int START_DEAD_BAND_TIME = 300;  // *10msec = 3sec
  static const int NOISE_WIDTH = 5;
